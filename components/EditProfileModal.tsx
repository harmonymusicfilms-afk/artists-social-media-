...
import { X, Save, Briefcase, MapPin, Languages, Sparkles, Link as LinkIcon, User, Image, Phone, Facebook, Globe, Palette, Shield, DollarSign, Award, Plus, Trash2, Youtube } from 'lucide-react';
import { UserProfile, PlatformRole, ArtistCategory } from '../../types';
import { PLATFORM_ROLES, ARTIST_CATEGORIES } from '../constants';
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                 ...
                 <div className="mt-6">
                    <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Bio / About Me</label>
                    <textarea name="bio" value={formData.bio || ''} onChange={handleChange} rows={4} placeholder="Tell everyone about your journey and vision..." className="w-full p-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl outline-none focus:ring-2 focus:ring-brand-orange"></textarea>
                </div>
            </section>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                         <div>
                            ...
                            <div className="relative">
                                ...
                                <input value={formData.artist?.genres?.join(', ') || ''} onChange={(e) => handleArrayChange(e, 'artist.genres')} type="text" placeholder="e.g., Rock, Pop, Classical" className="w-full p-3 pl-10 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl outline-none focus:ring-2 focus:ring-brand-orange" />
                            </div>
                        </div>
                         <div>
                            ...
                            <div className="relative">
                                <Sparkles className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                                <input value={formData.artist?.specialties?.join(', ') || ''} onChange={(e) => handleArrayChange(e, 'artist.specialties')} type="text" placeholder="e.g., Live Performance, Studio Recording" className="w-full p-3 pl-10 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl outline-none focus:ring-2 focus:ring-brand-orange" />
                            </div>
                        </div>
                    </div>
